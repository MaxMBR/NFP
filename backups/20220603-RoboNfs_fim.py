...
#    elemento_texto_pass = chrome.find_element(By.XPATH, '//*[@id="Password"]')
    ...
    if captcha_validado == True:
        ...
        try:
            ...
            chrome.find_element(By.XPATH, '//*[@id="menuSuperior"]/ul/li[4]/a')
            return True
...
def lancar_notas():
    for i, j in df.iterrows():
        ...
        t = i + 1
        statusTotal = f'Processando registro {t} de XPTO...'
...
class Tela:
    def __init__(self, master=None):
        ...
        self.lblTotal = Label(self.containerTotal, text="Total de registros importados: ", font=self.fontePadrao)
        self.lblTotal.pack(side = BOTTOM, expand = YES, fill = BOTH )
